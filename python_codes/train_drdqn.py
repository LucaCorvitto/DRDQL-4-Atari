...
def train(env_name, network_name, total_steps):
    ...
    target_agent = Agent(in_channels, num_actions, start_eps, seq_len, minibatch_size).to(device)
    ...
    while num_steps < total_steps:
        ...
        target_agent.reset_hidden_state()
        ...
        for update in range(updating_steps):
            ...
            # target
            target_Q = target_agent(next_obs, minibatch_size, target_a=True)[range(minibatch_size), next_obs_Q_max].detach()
